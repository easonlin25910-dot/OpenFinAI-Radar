...
<main><div class="notice">窗口：{window['start']} 至 {window['end']}。分布统计基于本页展示的 {total} 条候选。真实产品发布或上线时间及自动推断内容仍需人工补证。</div><div class="distributions">{charts}</div><div class="grid">{_cards(cases)}</div></main>
</body></html>"""
